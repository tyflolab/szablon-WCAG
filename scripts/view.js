var view = (function () {
  ...
  function loadPageWithSpecificConfiguration() {
    onReadyPage(function () {
      if (sessionStorage.getItem("loadConfiguration") == null) {
        sessionStorage.setItem("loadConfiguration", false);
        sessionStorage.setItem("configurationKeyBLoaded", false);
        sessionStorage.setItem("configurationKeyPLoaded", false);
      }

      if (
        sessionStorage.getItem("loadConfiguration") == "false" ||
        sessionStorage.getItem("configurationKeyBLoaded") == "true"
      ) {
        $("#changeConfigMathJaxBtn").text("Konfiguracja: MathML");
        $("#changeConfigMathJaxBtn").attr(
          "data-original-title",
          "Zmień konfiguracje na MathJax"
        );
        $("#changeConfigMathJaxBtn").attr(
          "aria-label",
          "Zmień konfiguracje na MathJax"
      ...
      } else if (sessionStorage.getItem("configurationKeyPLoaded") == "true") {
        $("#changeConfigMathJaxBtn").text("Konfiguracja: MathJax");
        $("#changeConfigMathJaxBtn").attr(
          "data-original-title",
          "Zmień konfiguracje na MathML"
        );
        $("#changeConfigMathJaxBtn").attr(
          "aria-label",
          "Zmień konfiguracje na MathML"
        ...
        if (sessionStorage.getItem("configurationKeyPLoaded") == "true") {
          let scriptTag = document.createElement("script");
          scriptTag.type = "text/javascript";
          scriptTag.defer = true;
          scriptTag.src =
  ...
  return {
    ...
    renderTree,
    /**
     * Loading page with specific configuration
     */
    loadPageWithSpecificConfiguration,
  };
})();
